...
export default function PublicPetGallery({
  ...
  useEffect(() => {
    if (currentIndex > orderedPhotos.length - 1) {
      setCurrentIndex(0)
    }
  }, [currentIndex, orderedPhotos.length])
  ...
  const currentCirclePhoto = orderedPhotos[currentIndex] || coverPhoto
  ...
  return (
    <div className="relative pb-16">
      ...
      <div className="absolute left-1/2 top-full z-20 -translate-x-1/2 -translate-y-[82%]">
